            ...
            <div class="card">
              ...
              <div class="card-body">
                <table class="table table-bordered table-hover">
                 <%@page import="com.controller.CustomerFetch"%>
                 <%@page import="com.dao.CustomerFetchDao" %>
                 <%@page import="java.util.ArrayList"%>
                 <%@page import="com.model.CustomerFetchpojo"%>
                 <% ArrayList<CustomerFetchpojo> list=(ArrayList<CustomerFetchpojo>) session.getAttribute("customer"); %>
