        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-lg-auto">
                    ...
                    <li class="nav-item">
                        <a href="/Addaccount.jsp" class="nav-link smoothScroll">Account Info</a>
                    </li>
          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="ml-auto col-lg-5 col-md-6 col-12">
                        <h2 class="mb-4 pb-2" data-aos="fade-up" data-aos-delay="200">Add Account</h2>
                        
                         

                       <form action="/NETBANKING/Deleteaccount" name="Deleteaccount" method="post">
                ...
                <input type="text" class="form-control" name="accno" placeholder="Account no">
                            ...
                            <button type="submit" class="form-control" id="submit-button" name="submit">Delete Account</button>
                        </form>
                    </div>
