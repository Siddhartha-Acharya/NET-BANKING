          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="ml-auto col-lg-5 col-md-6 col-12">
                       ...
                       <form action="/NETBANKING/Updateaccount" name="Updateaccount" method="post">
                ...
                <input type="text" class="form-control" name="balance" placeholder="Balance">
                            ...
                            <button type="submit" class="form-control" id="submit-button" name="submit">Update Account</button>
                        </form>
                    </div>
