          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="ml-auto col-lg-5 col-md-6 col-12">
                        <h2 class="mb-4 pb-2" data-aos="fade-up" data-aos-delay="200">Fix Deposit</h2>
                        
                         

                       <form action="/NETBANKING/FD" name="FD" method="post">
                
                         
                <input type="text" class="form-control" name="accno" placeholder="Account no">
                <input type="text" class="form-control" name="amount" placeholder="Amount">
                <input type="text" class="form-control" name="noofyear" placeholder="No of Year">
