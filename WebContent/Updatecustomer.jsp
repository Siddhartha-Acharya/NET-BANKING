          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="ml-auto col-lg-5 col-md-6 col-12">
                       ...
                       <form action="/NETBANKING/Updatecustomer" name="Updatecustomer" method="post">
           ...
           <input type="hidden" value="${param.cemail}" name="cemail">
                ...
                <input type="password" class="form-control" name="password" placeholder="password">
                            ...
                            <button type="submit" class="form-control" id="submit-button" name="submit">Update Customer</button>
                        </form>
                    </div>
