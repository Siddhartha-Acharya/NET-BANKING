        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-lg-auto">
                    ...
                    <li class="nav-item">
                        <a href="#contact" class="nav-link smoothScroll">Fund Transfer</a>
                    </li>
                </ul>
                    ...
                    <div class="row">
                         ...
                         <div class="col-lg-8 col-md-10 mx-auto col-12">
                              <div class="hero-text mt-5 text-center">
                                    ...
                                    <h6 data-aos="fade-up" data-aos-delay="300">Welcome to our XYZ Bank</h6>

                                    <h1 class="text-white" data-aos="fade-up" data-aos-delay="500">Belief is everything</h1>
                    ...
                    <div class="row">
                            ...
                            <div class="ml-lg-auto col-lg-3 col-md-6 col-12" data-aos="fade-up" data-aos-delay="700">
                                <div class="team-thumb">
                                    <img src="images1/team/team-image.jpg" class="img-fluid" alt="Trainer">
                            ...
                            <div class="mr-lg-auto mt-5 mt-lg-0 mt-md-0 col-lg-3 col-md-6 col-12" data-aos="fade-up" data-aos-delay="800">
                                <div class="team-thumb">
                                    <img src="images1/team/team-image01.jpg" class="img-fluid" alt="Trainer">
                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="400">
                                <div class="class-thumb">
                                    <img src="images1/class/yoga-class.jpg" class="img-fluid" alt="Class">
                            ...
                            <div class="mt-5 mt-lg-0 mt-md-0 col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="500">
                                <div class="class-thumb">
                                    <img src="images1/class/crossfit-class.jpg" class="img-fluid" alt="Class">
                            ...
                            <div class="mt-5 mt-lg-0 col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="600">
                                <div class="class-thumb">
                                    <img src="images1/class/cardio-class.jpg" class="img-fluid" alt="Class">
          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="ml-auto col-lg-5 col-md-6 col-12">
                       ...
                       <form action="/NETBANKING/FundTransferController" name="FundTransferController" method="post">
                <input type="text" class="form-control" name="saccno" placeholder="SAccount Number">

                <input type="text" class="form-control" name="baccno" placeholder="Account Number"  pattern="[0-9]{16}" required>

                <input type="tel" class="form-control" name="amount" placeholder="1234567890">

                <input type="text" class="form-control" name="tdt" placeholder="TDT">

                            <button type="submit" class="form-control" id="submit-button" name="submit">Fund Transfer</button>
                        </form>
                    </div>
      ...
      <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="" name="FundTransferController" method="post">
                <input type="text" class="form-control" name="saccno" placeholder="SAccount Number">

                <input type="email" class="form-control" name="baccno" placeholder="Account Number"  pattern="[0-9]{16}" required>

                <input type="tel" class="form-control" name="amount" placeholder="1234567890" pattern="[0-9]" required>

                <input type="text" class="form-control" name="tdt" placeholder="TDT">

                <button type="submit" class="form-control" id="submit-button" name="submit">Transfer</button>
