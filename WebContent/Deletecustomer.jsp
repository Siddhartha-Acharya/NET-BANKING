          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="ml-auto col-lg-5 col-md-6 col-12">
                       ...
                       <form action="/NETBANKING/Deletecustomer" name="Deletecustomer" method="post">
                ...
                <input type="text" class="form-control" name="cid" placeholder="customer Id">
                            ...
                            <button type="submit" class="form-control" id="submit-button" name="submit">Delete Customer</button>
                        </form>
                    </div>
